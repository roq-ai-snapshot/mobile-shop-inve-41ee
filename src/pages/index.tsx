  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="is your ultimate solution for seamless tracking, organizing, and optimizing your mobile shop's inventory for maximum efficiency and profitability."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`is your ultimate solution for seamless tracking, organizing, and optimizing your mobile shop's inventory for maximum efficiency and profitability.`}
            </Text>
            <Box
