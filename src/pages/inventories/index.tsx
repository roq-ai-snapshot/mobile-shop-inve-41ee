...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getInventories({
        relations: ['organization', 'purchase_history.count', 'sales.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['device_name.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'device_name', header: 'Device Name', accessorKey: 'device_name' },
